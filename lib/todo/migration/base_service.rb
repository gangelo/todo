  ...
  module Migration
    class BaseService
      ...
      def create_backup
        ...
        FileUtils.cp_r(todo_folder, backup_folder)
      ...
      def seed_data_folder
        seed_data_todo_folder_for(migration_version: to_migration_version)
      end

      def seed_data_configuration
        seed_data_todo_configuration_for(migration_version: to_migration_version)
      end
