    ...
    module V20230613121411
      class Service < BaseService
        ...
        def run_migration!
          ...
          copy_new_todo_folders
          copy_new_todo_configuration
        ...
        def copy_new_todo_folders
          puts 'Copying new todo folders...'

          FileUtils.cp_r(File.join(seed_data_folder, '.'), File.join(root_folder, 'todo')) unless pretend?
        end

        def copy_new_todo_configuration
          puts 'Copying new todo configuration...'
