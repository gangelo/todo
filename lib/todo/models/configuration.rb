...
module Todo
  module Models
    # This class represents the todo configuration.
    class Configuration < Crud::JsonFile
      ...
      DEFAULT_CONFIGURATION = {
        ...
        # If true, when using todo commands that list date ranges (e.g.
        # `todo list dates`), the displayed list will include dates that
        # have no todo entries. If false, the displayed list will only
        # include dates that have todo entries.
        # For all other `todo list` commands, if true, this option will
