  ...
  module Support
    module CommandOptions
      module TodoTimes
        ...
        def todo_times_for(from_option:, to_option:)
          from_time = todo_from_time_for(from_option: from_option)
          to_time = todo_to_time_for(to_option: to_option, from_time: from_time)
        ...
        def todo_from_time_for(from_option:)
        ...
        def todo_to_time_for(to_option:, from_time:)
