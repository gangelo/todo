...
RSpec.describe Doto::Support::CommandOptions::DotoTimes do
  ...
  describe '.doto_times_for' do
    subject(:from_to_time) do
      described_class.doto_times_for(from_option: from_option, to_option: to_option)
    end
