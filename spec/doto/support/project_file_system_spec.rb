...
RSpec.describe Doto::Support::ProjectFileSystem do
  subject(:project_file_system) do
    Class.new do
      include Doto::Support::ProjectFileSystem
  ...
  describe '#exist?' do
    context 'when the project file exists' do
      before do
        project_file_system.class.initialize_project(project_name: project_name)
        project_file = Doto::Support::Fileable.project_file_for(project_name: project_name)
  ...
  describe '#project_initialized?' do
    ...
    context 'when the projects folder does not exist' do
      before do
        project_file_system.class.initialize_project(project_name: project_name)
        projects_folder = Doto::Support::Fileable.projects_folder
    ...
    context 'when the project folder does not exist' do
      before do
        project_file_system.class.initialize_project(project_name: project_name)
        project_folder = Doto::Support::Fileable.project_folder_for(project_name: project_name)
    ...
    context 'when the current project file does not exist' do
      before do
        project_file_system.class.initialize_project(project_name: project_name)
        current_project_file = Doto::Support::Fileable.current_project_file
