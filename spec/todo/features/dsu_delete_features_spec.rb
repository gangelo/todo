...
RSpec.describe 'Todo delete features', type: :feature do
  ...
  shared_examples 'the entry groups are deleted' do |deleted_count|
    let(:expected_output) do
      Todo::Services::StdoutRedirectorService.call do
        ...
        Todo::Views::Shared::Success.new(messages: message).render
      end
    end
  ...
  context "when 'todo help delete' is used" do
  ...
  context "when 'todo delete date DATE|MNEMONIC' is used" do
    ...
    context 'with a date' do
      let(:args) do
        [
          'delete',
          'date',
          Todo::Support::TimeFormatable.yyyy_mm_dd(time: time, separator: '/'),
          '--prompts', 'any:true'
        ]
      end
  ...
  context "when 'todo delete dates OPTIONS' is used" do
    ...
    context "when 'todo delete dates -f FROM_DATE -t TO_DATE' is used" do
      let(:args) do
        [
          'delete',
          'dates',
    ...
    context "when 'todo delete dates -f MNEMONIC -t TO_DATE' is used" do
      let(:args) do
        [
          'delete',
          'dates',
    ...
    context "when 'todo delete dates -f FROM_DATE -t MNEMONIC' is used" do
      let(:args) do
        [
          'delete',
          'dates',
    ...
    context "when 'todo delete dates -f MNEMONIC -t MNEMONIC' is used" do
