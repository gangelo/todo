...
RSpec.describe Todo::Migration::V20240210161248::Service, type: :migration do
  ...
  describe '#migrate_if!' do
    ...
    context 'when the migration version is not 20230613121411' do
      ...
      let(:actual) { Todo::Support::Fileable.todo_folder }
    ...
    context 'when the migration version is 20230613121411' do
      ...
      context 'when the pretend option is set to false' do
        ...
        it 'migrates the todo folder structure and configuration file' do
          expect(todo_folders_and_file_contents_match?(expected: expected, actual: actual)).to be(true)
        end
      end
    end
