...
RSpec.describe Todo::Support::CommandOptions::TodoTimes do
  ...
  describe '.todo_times_for' do
    subject(:from_to_time) do
      described_class.todo_times_for(from_option: from_option, to_option: to_option)
    end
