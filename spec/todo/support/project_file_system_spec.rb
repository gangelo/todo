...
RSpec.describe Todo::Support::ProjectFileSystem do
  subject(:project_file_system) do
    Class.new do
      include Todo::Support::ProjectFileSystem
  ...
  describe '#exist?' do
    context 'when the project file exists' do
      before do
        project_file_system.class.initialize_project(project_name: project_name)
        project_file = Todo::Support::Fileable.project_file_for(project_name: project_name)
  ...
  describe '#project_initialized?' do
    ...
    context 'when the projects folder does not exist' do
      before do
        project_file_system.class.initialize_project(project_name: project_name)
        projects_folder = Todo::Support::Fileable.projects_folder
    ...
    context 'when the project folder does not exist' do
      before do
        project_file_system.class.initialize_project(project_name: project_name)
        project_folder = Todo::Support::Fileable.project_folder_for(project_name: project_name)
    ...
    context 'when the current project file does not exist' do
      before do
        project_file_system.class.initialize_project(project_name: project_name)
        current_project_file = Todo::Support::Fileable.current_project_file
