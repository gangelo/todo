...
RSpec.describe Todo::Validators::VersionValidator do
  subject(:version_validator) do
    Class.new do
      ...
      validates_with Todo::Validators::VersionValidator
    end.new(version: version)
  end

  before do
    version_validator.class.const_set(:VERSION, Todo::VERSION)
  end
