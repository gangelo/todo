...
RSpec.describe Todo::Views::Project::DeleteByNumber do
  ...
  shared_examples 'the project does not exist' do
    it 'does not exist' do
      expect(Todo::Models::Project.exist?(project_name: project_name)).to be(false)
    end
  end

  shared_examples 'the project exists' do
    it 'exists' do
      expect(Todo::Models::Project.exist?(project_name: project_name)).to be(true)
    end
  end
